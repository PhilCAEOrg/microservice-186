 ...
 * 186 - Test Class
 *
 * This class provides a basic testing framework for the microservice 186. It was
...
public class Res3Test {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Res3.class.getCanonicalName(),"0.1");

  private static final String mainPath = "res3";
  ...
  public void testnosong() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/nosong", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testnosong': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
